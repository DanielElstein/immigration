...
if submit_button:
        template = """
        Lawyer: Hello! I am your friendly immigration lawyer. I respond to questions in detail, in the same language they are asked. I can speak every language. How can I assist you today?
